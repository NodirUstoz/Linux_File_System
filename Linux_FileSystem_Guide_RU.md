...
**Терминал** — это текстовое окно интерфейса.

**Shell** — это программа, обрабатывающая команды. Популярные оболочки:
- **Bash** (Bourne Again Shell) — самый распространённый
- **Zsh** — с современными возможностями
- **Fish** — удобный для пользователя
